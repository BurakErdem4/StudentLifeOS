// --- globals.jsx ---
// Shared constants, icon components, and utility helpers used across all panels.
// Loaded before all other components via <script type="text/babel">.
...
const getStatusInfo = (percent, hasTasks) => {
    if (!hasTasks) return { color: "#F3F4F6", text: "Plan Yok", textColor: "#9CA3AF" };
    if (percent === 0) return { color: "#9CA3AF", text: "Henüz Başlamadın...", textColor: "white" };
    if (percent <= 20) return { color: "#EF4444", text: "Harekete Geç!", textColor: "white" };
    if (percent <= 40) return { color: "#F97316", text: "Isınıyorsun 🔥", textColor: "white" };
    if (percent <= 60) return { color: "#EAB308", text: "Yarıladın 🚀", textColor: "white" };
    if (percent < 100) return { color: "#22C55E", text: "Harika Gidiyorsun", textColor: "white" };
    return { color: "#06B6D4", text: "Efsane Bir Gün 💎", textColor: "white" };
};
